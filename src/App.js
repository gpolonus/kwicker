...
function App() {
  ...
  useEffect(() => {
    ...
    // Mousetrap.bind(['ctrl+up', 'command+up'], focusMove(0, 0))
    // Mousetrap.bind(['ctrl+down', 'command+down'], focusMove(0, 0))
    Mousetrap.bind(['ctrl+left', 'command+left'], focusMove(0, -1))
    Mousetrap.bind(['ctrl+right', 'command+right'], focusMove(0, 1))
